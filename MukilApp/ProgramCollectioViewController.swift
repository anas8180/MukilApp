//
//  ProgramCollectioViewController.swift
//  MukilApp
//
...
class ProgramCollectioViewController: UICollectionViewController,UICollectionViewDelegateFlowLayout {
...
//        self.collectionView!.registerClass(UICollectionViewCell.self, forCellWithReuseIdentifier: reuseIdentifier)
        ...
        manager.GET(
            ...
            success: { (operation: AFHTTPRequestOperation!,
                ...
                self.dataArray = responseObject.valueForKey("Programs") as! NSArray
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        let programDetailVC = destinationVC.topViewController as! ProgramsDetailViewController
        ...
        let fb:String = self.dataArray.objectAtIndex(indexPath!.row).objectForKey("fb") as! String

        let google:String = self.dataArray.objectAtIndex(indexPath!.row).objectForKey("googlePlus") as! String

        
        let dictionary:[String : String] = ["Audio":audio,"Video":video,"Facebook":fb,"Google":google]
        
        programDetailVC.appendDict = dictionary
        programDetailVC.title = self.dataArray.objectAtIndex(indexPath!.row).objectForKey("title") as? String
    ...
    func configureCell(cell:CustomCollectionViewCell,indexPath:NSIndexPath)
    {
        ...
        var escapedString:String = linkString.stringByReplacingOccurrencesOfString(" ", withString: "%20") as String
