...
//                println("JSON: " + responseObject.description)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        var cell : CustomTableViewCell = tableView.dequeueReusableCellWithIdentifier("CustomCell", forIndexPath: indexPath) as! CustomTableViewCell
    ...
    func configureCell(cell:CustomTableViewCell, indexPath:NSIndexPath)
    {
        ...
        getImage.resume()        // Configure the cell...
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        let dataDict : [String : String] = self.dataArray.objectAtIndex(indexPath!.row) as! Dictionary
        
        let destinationView = segue.destinationViewController as! RadioPlayViewController
        destinationView.dataDict = dataDict
